...
- (void)viewDidLoad {
    ...
    /// 初始化 地址偏移， 并返回错误码【主要用来判断版本号是否可用，也就是是否在iOS 11.0 -- 11.3】
    switch (offsets_init()) {
        case ERR_NOERR: {
            break;
        }
        case ERR_VERSION: { /// 系统版本号错误，设置成不可越狱状态
...
//=================================================================
//                tappedOnHyperlink、 credits、tappedOnSetNonce 请忽略作用
//=================================================================
#pragma mark - credits

- (IBAction)tappedOnHyperlink:(id)sender { //联系
